...
public final class ErrorConstants {
  ...
  public static class Money {
    ...
    public static final String CURRENCY_IS_NOT_SUPPORTED =
    ...
    public static final String DETAILS_ARE_REQUIRED =
        "Money details (amount and currency) are required.";
  }
  ...
  public static class Month {
    ...
    public static final String INVALID_FORMAT =
        "Invalid month format. Please use the format YYYY-MM.";
  }
  ...
  public static class Enum {
    ...
    public static final String EXAMPLE_ENUM_EXCEPTION =
        "java.lang.IllegalArgumentException: No enum constant com.example.Color.BLUEE";
    public static final String EXAMPLE_NON_ENUM_EXCEPTION =
        "java.lang.IllegalArgumentException: Some other error";
