...
class IncomeControllerTest {
  ...
  private IncomeRequest updatedIncomeRequest =
      IncomeRequestBuilder.updatedIncomeRequest().buildRequest();
  ...
  class CreateIncomeOperations {
    ...
    void createIncome_withValidRequest_returnsCreated() throws Exception {
      when(incomeService.createIncome(any(IncomeRequest.class))).thenReturn(defaultIncome);

      ResultActions validPostRequest =
          mockMvc.perform(
              post(PathConstants.Endpoints.INCOME)
                  .contentType(MediaType.APPLICATION_JSON)
                  .content(objectMapper.writeValueAsString(defaultIncomeRequest)));

      IncomeControllerAssertions.assertThat(validPostRequest).isDefaultIncomeResponse();
    ...
    void createIncome_withServiceError_returnsInternalServerError() throws Exception {
      ...
      IncomeControllerAssertions.assertThat(serviceErrorRequest).isInternalServerError();
    ...
    void createIncome_withDataIntegrityViolation_returnsConflict() throws Exception {
      ...
      IncomeControllerAssertions.assertThat(conflictRequest).isConflict();
  ...
  class GetIncomeOperations {
    ...
    void getIncome_withValidId_returnsOk() throws Exception {
      when(incomeService.getIncomeById(IncomeConstants.Default.ID)).thenReturn(defaultIncome);

      ResultActions validGetRequest =
          mockMvc.perform(
              get(PathConstants.Endpoints.INCOME_WITH_ID, IncomeConstants.Default.ID)
                  .contentType(MediaType.APPLICATION_JSON));

      IncomeControllerAssertions.assertThat(validGetRequest).isDefaultIncomeResponse();
      ...
      when(incomeService.getIncomeById(IncomeConstants.NonExistent.ID))
          .thenThrow(
              new IncomeNotFoundException(
                  String.format(
                      ErrorConstants.Income.NOT_FOUND_WITH_ID, IncomeConstants.NonExistent.ID)));

      ResultActions nonExistentIdGetRequest =
          mockMvc.perform(
              get(PathConstants.Endpoints.INCOME_WITH_ID, IncomeConstants.NonExistent.ID)
                  .contentType(MediaType.APPLICATION_JSON));
    ...
    void getAllIncomes_withValidMonth_returnsOk() throws Exception {
      ...
      ResultActions validGetRequest =
          mockMvc.perform(
              get(PathConstants.Endpoints.INCOME)
                  .param(
                      PathConstants.RequestParams.MONTH,
                      IncomeConstants.Default.YEAR_MONTH.toString())
                  .contentType(MediaType.APPLICATION_JSON));
  ...
  class UpdateIncomeOperations {
    ...
    void updateIncome_withValidRequest_returnsOk() throws Exception {
      ...
      ResultActions validPutRequest =
          mockMvc.perform(
              put(PathConstants.Endpoints.INCOME_WITH_ID, IncomeConstants.Default.ID)
                  .contentType(MediaType.APPLICATION_JSON)
                  .content(objectMapper.writeValueAsString(updatedIncomeRequest)));

      IncomeControllerAssertions.assertThat(validPutRequest).isUpdatedIncomeResponse();
    ...
    void updateIncome_withNonExistentId_returnsNotFound() throws Exception {
      ...
      ResultActions nonExistentIdPutRequest =
          mockMvc.perform(
              put(PathConstants.Endpoints.INCOME_WITH_ID, IncomeConstants.NonExistent.ID)
                  .contentType(MediaType.APPLICATION_JSON)
                  .content(objectMapper.writeValueAsString(updatedIncomeRequest)));
  ...
  class DeleteIncomeOperations {
    ...
    void deleteIncome_withValidId_returnsNoContent() throws Exception {
      doNothing().when(incomeService).deleteIncome(IncomeConstants.Default.ID);

      ResultActions validDeleteRequest =
          mockMvc.perform(
              delete(PathConstants.Endpoints.INCOME_WITH_ID, IncomeConstants.Default.ID));

      IncomeControllerAssertions.assertThat(validDeleteRequest).isNoContent();
    ...
    void deleteIncome_withNonExistentId_returnsNotFound() throws Exception {
      ...
      ResultActions nonExistentIdDeleteRequest =
          mockMvc.perform(
              delete(PathConstants.Endpoints.INCOME_WITH_ID, IncomeConstants.NonExistent.ID));
