...
class GlobalExceptionHandlerTest {
  ...
  class ValidationExceptionHandling {
    ...
    void handleConstraintViolation_withViolations_returnsBadRequestWithValidationErrors() {
      ...
      ResponseEntity<ErrorResponse> response =
          globalExceptionHandler.handleConstraintViolation(ex, webRequest);
  ...
  class RequestProcessingExceptionHandling {
    ...
    void handleInvalidRequest_withValueInstantiationException_returnsBadRequest() {
      ...
      ResponseEntity<ErrorResponse> response =
          globalExceptionHandler.handleInvalidRequest(ex, webRequest);

      ErrorResponseAssertions.assertErrorResponse(response).matchesInvalidEnumValue();
    }
  }
  ...
  class SystemExceptionHandling {
    ...
    void handleGenericException_returnsInternalServerError() {
      ...
      ErrorResponseAssertions.assertErrorResponse(response).matchesInternalServerError();
    }
    ...
    void handleDataIntegrityViolation_returnsConflict() {
      DataIntegrityViolationException ex =
          new DataIntegrityViolationException(ErrorCode.DATABASE_ERROR.getMessage());

      ResponseEntity<ErrorResponse> response =
          globalExceptionHandler.handleDataIntegrityViolation(ex, webRequest);

      ErrorResponseAssertions.assertErrorResponse(response).matchesConflict();
    }
  }
  ...
  class ResourceNotFoundHandling {
    ...
    void handleBudgetNotFound_returnsNotFound() {
      BudgetNotFoundException ex =
          new BudgetNotFoundException(ErrorCode.RESOURCE_NOT_FOUND.getMessage());

      ResponseEntity<ErrorResponse> response =
          globalExceptionHandler.handleBudgetNotFound(ex, webRequest);

      ErrorResponseAssertions.assertErrorResponse(response).matchesResourceNotFound();
    }
    ...
    void handleIncomeNotFound_returnsNotFound() {
      IncomeNotFoundException ex =
          new IncomeNotFoundException(ErrorCode.RESOURCE_NOT_FOUND.getMessage());

      ResponseEntity<ErrorResponse> response =
          globalExceptionHandler.handleIncomeNotFound(ex, webRequest);
    ...
    void handleExpenseNotFound_returnsNotFound() {
      ExpenseNotFoundException ex =
          new ExpenseNotFoundException(ErrorCode.RESOURCE_NOT_FOUND.getMessage());

      ResponseEntity<ErrorResponse> response =
          globalExceptionHandler.handleExpenseNotFound(ex, webRequest);
