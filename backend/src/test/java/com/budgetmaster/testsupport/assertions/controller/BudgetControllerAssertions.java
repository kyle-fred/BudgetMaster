...
public class BudgetControllerAssertions {
  ...
  public BudgetControllerAssertions hasTotalIncome(BigDecimal expectedTotalIncome)
      throws Exception {
    resultActions.andExpect(
        jsonPath(PathConstants.JsonProperties.TOTAL_INCOME).value(expectedTotalIncome.toString()));
    return this;
  }

  public BudgetControllerAssertions hasTotalExpense(BigDecimal expectedTotalExpense)
      throws Exception {
    resultActions.andExpect(
        jsonPath(PathConstants.JsonProperties.TOTAL_EXPENSE)
            .value(expectedTotalExpense.toString()));
    return this;
  }

  public BudgetControllerAssertions hasSavings(BigDecimal expectedSavings) throws Exception {
    resultActions.andExpect(
        jsonPath(PathConstants.JsonProperties.SAVINGS).value(expectedSavings.toString()));
    return this;
  }

  public BudgetControllerAssertions hasCurrency(Currency expectedCurrency) throws Exception {
    resultActions.andExpect(
        jsonPath(PathConstants.JsonProperties.Money.CURRENCY)
  ...
  public BudgetControllerAssertions hasMonth(YearMonth expectedMonth) throws Exception {
    resultActions
        ...
        .andExpect(
            jsonPath(PathConstants.JsonProperties.Month.YEAR_VALUE).value(expectedMonth.getYear()))
        .andExpect(
            jsonPath(PathConstants.JsonProperties.Month.MONTH_VALUE)
