...
public class ExpenseControllerAssertions {
  ...
  public static ExpenseControllerAssertions assertThat(
      ResultActions resultActions, String basePath) {
  ...
  public ExpenseControllerAssertions hasName(String expectedName) throws Exception {
    resultActions.andExpect(
        jsonPath(basePath + PathConstants.JsonProperties.NAME).value(expectedName));
    return this;
  }

  public ExpenseControllerAssertions hasMoney(Money expectedMoney) throws Exception {
    MoneyControllerAssertions.assertThat(
            resultActions, basePath + PathConstants.JsonProperties.MONEY)
        .hasMoney(expectedMoney);
    return this;
  }

  public ExpenseControllerAssertions hasCategory(ExpenseCategory expectedCategory)
      throws Exception {
    resultActions.andExpect(
        jsonPath(basePath + PathConstants.JsonProperties.CATEGORY)
            .value(expectedCategory.toString()));
    return this;
  }

  public ExpenseControllerAssertions hasType(TransactionType expectedType) throws Exception {
    resultActions.andExpect(
        jsonPath(basePath + PathConstants.JsonProperties.TYPE).value(expectedType.toString()));
    return this;
  }
  ...
  public ExpenseControllerAssertions hasMonth(YearMonth expectedMonth) throws Exception {
    resultActions
        ...
        .andExpect(
            jsonPath(basePath + PathConstants.JsonProperties.Month.YEAR_VALUE)
                .value(expectedMonth.getYear()))
        .andExpect(
            jsonPath(basePath + PathConstants.JsonProperties.Month.MONTH_VALUE)
                .value(expectedMonth.getMonthValue()));
    return this;
  }
  ...
  public ErrorControllerAssertions isNotFoundForMonth(YearMonth month) throws Exception {
    return ErrorControllerAssertions.assertThat(resultActions)
        .isNotFoundResponse(
            String.format(ErrorConstants.Expense.NOT_FOUND_FOR_MONTH, month),
