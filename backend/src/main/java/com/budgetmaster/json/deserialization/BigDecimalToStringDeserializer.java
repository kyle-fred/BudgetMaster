...
/**
 * Deserializes string values back into BigDecimal objects. Handles null values and invalid number
 * formats gracefully.
 */
  ...
  private BigDecimal parseBigDecimal(String value) throws IOException {
    try {
      ...
      throw new IOException(
          String.format(ErrorMessages.Serialization.INVALID_BIG_DECIMAL_VALUE, value), e);
    }
  }
