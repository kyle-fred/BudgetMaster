...
class IncomeRequestTest {
  ...
  void validateRequest_withValidData_hasNoViolations() {
    ...
    IncomeDtoAssertions.assertIncomeRequest(violations).hasNoViolations();
  }
  ...
  class RequiredFieldValidations {
    ...
    void validateName_whenNull_hasNameRequiredViolation() {
      IncomeRequest incomeRequest =
          IncomeRequestBuilder.defaultIncomeRequest().withName(null).buildRequest();
    ...
    void validateSource_whenNull_hasSourceRequiredViolation() {
      IncomeRequest incomeRequest =
          IncomeRequestBuilder.defaultIncomeRequest().withSource(null).buildRequest();
    ...
    void validateMoney_whenNull_hasMoneyRequiredViolation() {
      IncomeRequest incomeRequest =
          IncomeRequestBuilder.defaultIncomeRequest().withMoney(null).buildRequest();
    ...
    void validateType_whenNull_hasTypeRequiredViolation() {
      IncomeRequest incomeRequest =
          IncomeRequestBuilder.defaultIncomeRequest().withType(null).buildRequest();
  ...
  class MonthFieldValidations {
    ...
    void validateMonth_whenNull_hasMonthRequiredViolation() {
      IncomeRequest incomeRequest =
          IncomeRequestBuilder.defaultIncomeRequest().withMonth(null).buildRequest();
    ...
    void validateMonth_whenInvalid_hasInvalidFormatViolation() {
      IncomeRequest incomeRequest =
          IncomeRequestBuilder.defaultIncomeRequest()
