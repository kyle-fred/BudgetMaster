...
public class MoneyAssertions {
    ...
    private MoneyAssertions(ResultActions resultActions) {
        this.resultActions = resultActions;
    }

    public static MoneyAssertions assertThat(ResultActions resultActions) {
        return new MoneyAssertions(resultActions);
    }

    public MoneyAssertions hasAmount(BigDecimal expectedAmount) throws Exception {
        resultActions.andExpect(jsonPath(PathConstants.JsonProperties.Money.AMOUNT).value(expectedAmount.toString()));
        return this;
    }
    ...
    // public MoneyAssertions isDefaultIncome() throws Exception {
    //     return hasAmount(IncomeConstants.Default.AMOUNT)
    //         .hasCurrency(IncomeConstants.Default.CURRENCY);
    // }
} 