...
public class MoneyRequestBuilder {
  ...
  public static MoneyRequestBuilder defaultZero() {
    return new MoneyRequestBuilder().withAmount(BigDecimal.ZERO);
  }

  public static MoneyRequestBuilder defaultIncome() {
    return new MoneyRequestBuilder().withAmount(MoneyConstants.IncomeDefaults.AMOUNT);
  }

  public static MoneyRequestBuilder defaultExpense() {
    return new MoneyRequestBuilder().withAmount(MoneyConstants.ExpenseDefaults.AMOUNT);
  }
