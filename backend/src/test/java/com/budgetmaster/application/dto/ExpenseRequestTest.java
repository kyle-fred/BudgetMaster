...
class ExpenseRequestTest {
  ...
  void validateRequest_withValidData_hasNoViolations() {
    ...
    ExpenseDtoAssertions.assertExpenseRequest(violations).hasNoViolations();
  }
  ...
  class RequiredFieldValidations {
    ...
    void validateName_whenNull_hasNameRequiredViolation() {
      ExpenseRequest expenseRequest =
          ExpenseRequestBuilder.defaultExpenseRequest().withName(null).buildRequest();
    ...
    void validateMoney_whenNull_hasMoneyRequiredViolation() {
      ExpenseRequest expenseRequest =
          ExpenseRequestBuilder.defaultExpenseRequest().withMoney(null).buildRequest();
    ...
    void validateCategory_whenNull_hasCategoryRequiredViolation() {
      ExpenseRequest expenseRequest =
          ExpenseRequestBuilder.defaultExpenseRequest().withCategory(null).buildRequest();
    ...
    void validateType_whenNull_hasTypeRequiredViolation() {
      ExpenseRequest expenseRequest =
          ExpenseRequestBuilder.defaultExpenseRequest().withType(null).buildRequest();
  ...
  class MonthFieldValidations {
    ...
    void validateMonth_whenNull_hasMonthRequiredViolation() {
      ExpenseRequest expenseRequest =
          ExpenseRequestBuilder.defaultExpenseRequest().withMonth(null).buildRequest();
    ...
    void validateMonth_whenInvalid_hasInvalidFormatViolation() {
      ExpenseRequest expenseRequest =
          ExpenseRequestBuilder.defaultExpenseRequest()
