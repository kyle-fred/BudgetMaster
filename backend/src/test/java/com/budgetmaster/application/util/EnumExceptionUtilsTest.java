  ...
  class FindEnumTypeOperations {
    ...
    void findEnumType_withValidField_returnsEnumClass() {
      Optional<Class<? extends Enum<?>>> enumType =
          EnumExceptionUtils.findEnumType(DummyClass.class, EnumConstants.Invalid.ENUM_FIELD);
    ...
    void findEnumType_withInvalidField_returnsEmptyOptional() {
      Optional<Class<? extends Enum<?>>> enumType =
          EnumExceptionUtils.findEnumType(DummyClass.class, EnumConstants.Invalid.FIELD_NAME);
