...
public class IncomeRequestTest {
    ...
    void testNullName() {
        ...
        assertEquals(Messages.Income.NAME_REQUIRED, violations.iterator().next().getMessage());
    }
    ...
    void testNullSource() {
        ...
        Set<ConstraintViolation<IncomeRequest>> violations = validator.validate(incomeRequest);
        assertEquals(1, violations.size());
        assertEquals(Messages.Income.SOURCE_REQUIRED, violations.iterator().next().getMessage());
    }
    ...
    void testNullType() {
        ...
        Set<ConstraintViolation<IncomeRequest>> violations = validator.validate(incomeRequest);
        assertEquals(1, violations.size());
        assertEquals(Messages.Income.TYPE_REQUIRED, violations.iterator().next().getMessage());
    }
