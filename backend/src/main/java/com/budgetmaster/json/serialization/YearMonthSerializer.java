...
/**
 * Serializes YearMonth values into a two-element array containing [year, month].
 * This format is more compact and easier to work with than string representations.
 */
