...
public class ErrorControllerAssertions {
  ...
  public ErrorControllerAssertions hasStatus(int expectedStatus) throws Exception {
    resultActions.andExpect(
        jsonPath(PathConstants.JsonProperties.Error.STATUS).value(expectedStatus));
    return this;
  }

  public ErrorControllerAssertions hasErrorCode(String expectedErrorCode) throws Exception {
    resultActions.andExpect(
        jsonPath(PathConstants.JsonProperties.Error.CODE).value(expectedErrorCode));
    return this;
  }

  public ErrorControllerAssertions hasMessage(String expectedMessage) throws Exception {
    resultActions.andExpect(
        jsonPath(PathConstants.JsonProperties.Error.MESSAGE).value(expectedMessage));
    return this;
  }
  ...
  public ErrorControllerAssertions hasNoValidationErrors() throws Exception {
    resultActions.andExpect(
        jsonPath(PathConstants.JsonProperties.Error.VALIDATION_ERRORS).isEmpty());
    return this;
  }

  public ErrorControllerAssertions isNotFoundResponse(String message, String path)
      throws Exception {
    return isNotFound()
        .hasTimestamp()
