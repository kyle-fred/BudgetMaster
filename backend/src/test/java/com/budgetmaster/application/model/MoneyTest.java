...
class MoneyTest {
    ...
    class ComparisonOperations {
        ...
        void isGreaterThan_withValidAmounts_returnsExpectedResult(String amount1, String amount2, boolean expected) {
        ...
        void isLessThan_withValidAmounts_returnsExpectedResult(String amount1, String amount2, boolean expected) {
            Money money1 = Money.of(amount1);
            Money money2 = Money.of(amount2);
        ...
        void isEqualTo_withValidAmounts_returnsExpectedResult(String amount1, String amount2, boolean expected) {
            Money money1 = Money.of(amount1);
            Money money2 = Money.of(amount2);
