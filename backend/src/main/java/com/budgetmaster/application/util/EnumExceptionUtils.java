...
public class EnumExceptionUtils {
  ...
  public static String extractInvalidEnumValue(String exceptionMessage) {
    int startIndex =
        exceptionMessage.indexOf(StringConstants.ExceptionMessages.NO_ENUM_CONSTANT_PREFIX);
  ...
  public static String extractEnumConstant(String enumPart) {
    enumPart =
        enumPart.replace(StringConstants.Punctuation.NEW_LINE, StringConstants.Punctuation.EMPTY);
  ...
  public static Optional<Class<? extends Enum<?>>> findEnumType(
      Class<?> modelClass, String fieldName) {
    try {
      @SuppressWarnings("unchecked")
      Class<? extends Enum<?>> enumType =
          (Class<? extends Enum<?>>) modelClass.getDeclaredField(fieldName).getType();
